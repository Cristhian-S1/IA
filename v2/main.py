import time
from v2_tetravex_optimized import (
...
while True:
    ...
    if opcion == "1":
        ...
        print("    e) 6x6  (36 piezas)")
        print("    f) 7x7  (49 piezas)")
        tam = input("  Seleccione: ").strip().lower()

        mapa_tam = {'a': 2, 'b': 3, 'c': 4, 'd': 5, 'e': 6, 'f':7}
    ...
    # ── 2: Puzzle manual ──
        ...
        sizes = mapa.get(sel, [2, 3, 4]) #por defecto devuelve b)
